...
from .services.tour_service import TourService   # <-- ИМПОРТ НОВОГО СЕРВИСА
...
class DIContainer:
    ...
    def __init__(self):
        ...
        self.tour_service = TourService()  # <-- ИНИЦИАЛИЗАЦИЯ
        ...
        self.main_controller = MainController(
            ...
            fs_repo=self.fs_repo,
            tour_service=self.tour_service,  # <-- ПРОБРОС В КОНТРОЛЛЕР
        )
