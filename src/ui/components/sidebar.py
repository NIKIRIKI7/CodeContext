...
class Sidebar(ctk.CTkFrame):
    def __init__(self, parent, controller, on_settings_change_callback):
        ...
        self.on_settings_change = on_settings_change_callback  # Коллбек для уведомления Main об изменении
    ...
    def _init_tabs(self):
        ...
        ctk.CTkLabel(self, text="v5.1 Dependency Graph", text_color="gray").grid(row=2, column=0, sticky="s", pady=10)
    ...
    def update_ui(self, settings):
        """Обновляет UI компонента на основе State"""
        ...
        # Update Prompt Preset Combobox Logic
        found = False
    ...
    def get_settings(self):
        """Возвращает настройки из элементов управления"""
        return {
