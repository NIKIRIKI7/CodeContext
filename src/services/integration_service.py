...
def install_context_menu(custom_python_path: Optional[str] = None) -> Tuple[bool, str]:
    sys_os = platform.system()
    try:
        if sys_os == "Windows":
            return _install_win(custom_python_path)
        elif sys_os == "Linux":
            return _install_linux(custom_python_path)
        elif sys_os == "Darwin":
            return _install_mac(custom_python_path)
...
def install_cli(custom_python_path: Optional[str] = None) -> Tuple[bool, str]:
    try:
        if platform.system() == "Windows":
            return _install_cli_win(custom_python_path)
        else:
            return _install_cli_unix(custom_python_path)
    except Exception as e:
        return False, f"Error: {e}"


def remove_cli() -> Tuple[bool, str]:
    try:
        if platform.system() == "Windows":
            return _remove_cli_win()
        else:
            return _remove_cli_unix()
    except Exception as e:
        return False, f"Error: {e}"


# --- Windows ---
def _install_win(custom_python_path: Optional[str] = None) -> Tuple[bool, str]:
    import winreg
...
# --- Unix / Mac ---
def _install_linux(custom_python_path: Optional[str] = None) -> Tuple[bool, str]:
...
def _install_cli_unix(custom_python_path: Optional[str] = None) -> Tuple[bool, str]:
...
def _remove_cli_unix() -> Tuple[bool, str]:
...
def _install_mac(custom_python_path: Optional[str] = None) -> Tuple[bool, str]:
